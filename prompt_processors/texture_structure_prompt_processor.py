...
from .base import PromptProcessor, hash_prompt


@threestudio.register("texture-structure-prompt-processor")
class StableDiffusionPromptProcessor(PromptProcessor):
    ...
    def get_text_embeddings(
    ...
    ) -> Tuple[Float[Tensor, "B 77 1024"], Float[Tensor, "B 77 1024"]]:
        ...
        with torch.no_grad():
            ...
            null_text_embeddings = self.text_encoder(
                null_tokens.input_ids.to(self.device)
            )[0]

        return text_embeddings, uncond_text_embeddings, null_text_embeddings
